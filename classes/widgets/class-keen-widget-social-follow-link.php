...
if ( ! class_exists( 'Keen_Widget_Social_Follow_Link' ) ) :

	/**
	 * Keen_Widget_Social_Follow_Link
	 *
	 * @since 1.0.0
	 */
	class Keen_Widget_Social_Follow_Link extends WP_Widget {
		 ...
		 */
		public $id_base = 'keen-widget-social-follow-link';
		...
		function __construct() {
			parent::__construct(
				$this->id_base,
				__( 'Keen: Social Follow Links', 'keen-widgets' ),
				array(
					'classname'   => $this->id_base,
					'description' => __( 'Display social links.', 'keen-widgets' ),
				),
				array(
